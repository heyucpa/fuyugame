...
const MOMENTS = [
  ...
  { id: 'm-change', place: 'shop',
    text: '買完早餐，你發現店長多找了你十塊錢。',
    choices: [
      { label: '拿回去還她', reply: '店長愣了一下，然後笑得很開心：「這個小孩真好。」<br><br>她多給了你一顆糖。' },
      { label: '先算一次確定有多', reply: '你數了兩次，確定真的多了。<br><br>還回去的時候店長說：「還好你有講，不然我晚上帳會對不起來。」' },
    ] },
  ...
  { id: 'm-queue', place: 'shop',
    ...
    choices: [
      ...
      { label: '照原本排', reply: '輪到你的時候，你順口跟店長說阿婆好像很趕。<br><br>店長很快幫她結了帳。' },
    ] },
  ...
  { id: 'm-wantbuy', place: 'shop',
    ...
    choices: [
      ...
      { label: '問店長可不可以先欠', reply: '店長笑著說：「這樣不行喔，不過我幫你留著。」<br><br>她真的幫你留了。' },
    ] },
  ...
  { id: 'm-catpark', place: 'park',
    ...
    choices: [
      ...
      { label: '去問熊伯伯', reply: '熊伯伯說那是這附近的老住戶了。<br><br>「牠比你早來公園。」他說。' },
    ] },
  ...
  { id: 'm-lostkid', place: 'park', care: true,
    ...
    choices: [
      { label: '去叫熊伯伯', reply: '熊伯伯馬上過來了，很快就找到那個孩子的阿嬤。<br><br>他跟你說：「找大人來，是最快的辦法。」' },
      { label: '陪他站在原地等', reply: '你陪他站著，一邊四處看有沒有大人。<br><br>熊伯伯經過的時候你喊住他——他說你做得很好，沒有自己把小孩帶走。' },
    ] },
  ...
  */
  ...
  { id: 'm-sis-ice', place: 'shop', sis: true, sib: 'both',
    ...
    choices: [
      ...
      { label: '說我們各買一種，一起分', reply: '貓店長笑著幫你們把兩支都剝好。<br><br>兩種口味你們都吃到了。' },
    ] },
